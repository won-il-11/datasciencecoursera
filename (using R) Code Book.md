##### collected signal data about motions from galaxy smartphone 
##### 
##### 
...
##### 
##### more information about statistic is in 'feautures_info.txt', also description exits below.
##### 
##### 
##### subject_id is 1:30 vector, 30 people in this experiment.
##### action 1:6 vector
##### also, several changes on action, which means actual activity(our prediction target).
...
##### 
##### 
##### each type is seperated with underscore, not using capital letters.
